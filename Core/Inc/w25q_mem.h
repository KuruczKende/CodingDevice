...
/// Mem size in MB-bit
#define MEM_FLASH_SIZE 8U   // 8 MB-bit
...
/// Blocks count
#define BLOCK_COUNT 128U // 512 blocks
/// Sector count
#define SECTOR_COUNT 2048U  // 8192 sectors
/// Pages count
#define PAGE_COUNT 32768U    // 131'072 pages
...
W25Q_STATE W25Q_WaitForWritingComplete(void);
W25Q_STATE W25Q_EnableMemoryMappedMode(void);
